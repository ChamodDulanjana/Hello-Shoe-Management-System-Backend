...
import com.chamoddulanjana.helloshoemanagementsystem.dto.InvoiceDTO;
...
public class InvoiceUtil {
    ...
    public byte[] getInvoice(InvoiceDTO dto) {
        ...
        double total = dto.getSaleDetailsList().stream().mapToDouble(SaleDetailsDTO::getTotal).sum();
        ...
        if (dto.getSaleDetailsList().isEmpty()) {
            ...
            for (SaleDetailsDTO item : dto.getSaleDetailsList()) {
